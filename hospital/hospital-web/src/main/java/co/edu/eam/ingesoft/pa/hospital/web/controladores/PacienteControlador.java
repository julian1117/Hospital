...
//						Messages.addFlashGlobalInfo("El email ya existe en el sistema!!");
//					}else{
						Eps epsB = generalEJB.buscarEps(eps.getIdEps());

						Paciente paciente = new Paciente(Long.parseLong(idPersona), nombre, apellido, fechaNacimiento, telefono, direccion, roll, email, sexo, ciu, eps);
